...
<head>
  ...
  <title>Student's Payment Details</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Student's Payment Details</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <form action="php-selectClass.php" method="GET">
              ...
              <!-- /.card-header -->
              <form action="php-payment.php" method="GET">
                <input type="hidden" name="t_id" value="<?php echo $_GET['t_id']; ?>">
                      ...
                      if(isset($_GET['c_id'])){
                        ...
                        <td>
                          <div class="btn-group container">
                            <button name="s_id" value="'.$rowPay['id'].'" class="btn btn-sm btn-success" '.$dis.'>Mark As Paid</button>
                          </div>
                        </td>
                      </tr>';
                          }
