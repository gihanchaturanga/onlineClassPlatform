  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Classes of <?php echo $_GET['name']; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <!-- Main content -->
    <form action="php-classes.php" method="GET">   
    ...
    <?php
    $id = $_GET['id'];
    $query = "SELECT * FROM class WHERE stat = '1' AND t_id = '$id'";
    ...
    while($row = mysqli_fetch_array($result)){
      ...
      <div class="card card-primary card-outline">
        ...
        <div class="card-body">
          ...
          <button type="submit" name="class" value="'.$row['id'].'" class="btn btn-primary">Join To Class</button>
        </div>
      </div>
    </div>';
    }
    ...
    ?>
          ...
          <!-- <div class="col-md-6">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">After Ordinary Level</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Web Development</h6>

                <p class="card-text">Every Subday 08:00AM on ZOOM platform</p>
                <button href="#" class="btn btn-primary">Join To Class</button>
              </div>
            </div>
          </div> -->
          ...
          <!-- <div class="col-md-6">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary">Join To Class</a>
              </div>
            </div>
          </div>
