    ...
    <section class="content">
      ...
      <div class="card card-solid">
        <div class="card-body pb-0">
          ...
          $query = "SELECT * FROM teacher WHERE stat = '1'";
            ...
            <div class="card bg-light d-flex flex-fill">
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-7">
                    ...
                    <p class="text-muted text-sm">'.$row['subjects'].'</p>
                    
                  </div>
                  <div class="col-5 text-center">
                    <img src="temp/dist/img/user1-128x128.jpg" alt="user-avatar" class="img-circle img-fluid">
                  </div>
                </div>
              </div>
              <div class="card-footer">
                <div class="text-right">
                  ...
                  <a href="classes.php?id='.$row['id'].'&name='.$row['name'].'" class="btn btn-sm btn-primary">
                    View Classes
                  </a>
                </div>
              </div>
            ...
            <!-- <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Gihan Chathuranga Attanayake</b></h2>
                      <p class="text-muted text-sm">Web development | Java Application Development</p>
