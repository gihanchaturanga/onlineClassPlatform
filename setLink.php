...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Set Links</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <form action="php-setLink.php" method="GET">
    <section class="content">
      <!-- form goes here -->
      <div class="offset-lg-3 col-lg-6 offset-md-2 col-md-8 col-sm-12 mt-md-3">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title"><b>Update</b> Class Links</h3>
          </div>
          <div class="card-body ">
            <!-- Date -->
            <?php

            $query = "SELECT * FROM class WHERE t_id = '1' AND stat = '1'";
            $result = mysqli_query($conn, $query);
            while($row = mysqli_fetch_array($result)){
              echo '<div class="form-group">
              <label><span class="text-primary">'.$row['grade'].'</span> - '.$row['subject'].'</label>
                <div class="input-group date">
                    <input value="'.$row['link'].'" name="'.$row['id'].'" type="text" class="form-control datetimepicker-input" data-target="#reservationdate"/>
            ...
            <div class="row mt-4">
              <div class="ml-auto mr-3">
                <button name="link" value="1" class="btn btn-primary"><i class="fas fa-link"></i>&nbsp&nbspUpdate Links</button>
              </div>
            </div>
            <!-- /.form group -->
          </div>
