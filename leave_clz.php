...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Subscribed Classes</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container-fluid">
      <form action="php-leave.php" method="GET">
        <div class="row">
          <!-- /.col-md-6 -->
                ...
                while($row = mysqli_fetch_array($result)){
                  ...
                  <div class="card card-danger card-outline">
                    ...
                    <div class="card-body">
                      ...
                      <button type="submit" name="c_id" value="'.$row['id'].'" class="btn btn-danger">Leave Class</button>
                    </div>
                  </div>
                </div>';
                }
          ...
          <!-- <div class="col-md-6">
            <div class="card card-danger card-outline">
              ...
              <div class="card-body">
                ...
                <button href="#" class="btn btn-danger">Leave Class</button>
              </div>
            </div>
          </div> -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Developed by : <a href="#">Revotech Solutions</a>.</strong>  All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
